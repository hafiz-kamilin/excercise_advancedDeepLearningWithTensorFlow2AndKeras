...
def autoencoderColorizer(input_shape):
...
if __name__ == "__main__":
    ...
    # get the shape for the image
    input_shape = (img_rows, img_cols, 1)

    # create the autoencoder model for colorizing the grayscale image
    model = autoencoderColorizer(input_shape)
