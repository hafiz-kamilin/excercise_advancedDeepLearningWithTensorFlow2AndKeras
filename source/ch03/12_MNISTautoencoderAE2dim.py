...
"""
Example of autoencoder model on MNIST dataset using 2-dim latent
...
#####################################################
# translate the 2-dim latent value into the xy-plot #
#####################################################

def plotLatentValueDistribution(
    models,
    data,
    batch_size=32,
...
if __name__ == "__main__":
    ...
    model, encoder, decoder = autoEncoderBuilder(input_shape)
